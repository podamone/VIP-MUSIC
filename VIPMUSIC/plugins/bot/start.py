...
"""
        ...
        try:
            ...
            vip = await message.reply_text(f"**ᴩᴏᴅᴀ ᴍʏʀᴇᴇ ꨄ︎🐌.....**")
            await vip.edit_text(f"**ᴩᴏᴅᴀ ᴍʏʀᴇ ꨄ︎.🐌....**")
            await vip.edit_text(f"**ᴩᴏᴅᴀ ᴍʏʀᴇ ꨄ︎..🐌...**")
            await vip.edit_text(f"**ᴩᴏᴅᴀ ᴍʏʀᴇ ꨄ︎...🐌..**")
            await vip.edit_text(f"**ᴩᴏᴅᴀ ᴍʏʀᴇ ꨄ︎....🐌.**")
            await vip.edit_text(f"**ᴩᴏᴅᴀ ᴍʏʀᴇ ꨄ︎.....🐌**")
            ...
            await vip.delete()
            vips = await message.reply_text("**⚡ʜ**")
            await asyncio.sleep(0.1)
            await vips.edit_text("**⚡ʜɪ**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡ʜɪ**")
            #  await asyncio.sleep(0.1)
            await vips.edit_text("**⚡ʜɪʙ**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡ѕтαят**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡ʜɪʙᴀ**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡ʜɪʙᴀ**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡ʜɪʙᴀ ѕтαятιиg**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**⚡ʜɪʙᴀ ѕтαятιиg.**")
            await asyncio.sleep(0.1)
            await vips.edit_text("**⚡ʜɪʙᴀ ѕтαятιиg....**")
            await asyncio.sleep(0.1)
            await vips.edit_text("**⚡ʜɪʙᴀᴀ ѕтαятιиg.**")
            await asyncio.sleep(0.1)
            await vips.edit_text("**⚡ʜɪʙᴀᴀᴀ ѕтαятιиg....**")
